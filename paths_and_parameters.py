...
### Input ###
path_scan = path_shared + 'dataXRDXRF/MuseiRealiVenere/'

path_xrd = path_scan + 'VenereXRD/Acquisition0001/'          # XRD scan
path_zmap = path_scan + 'VenereZPosition/'

path_xrf_elements = path_scan + 'VenereXRF/'       # XRF elements
path_xrf_spectra = path_scan + 'VenereXRFDATI/ExportEdf/'   # XRF scan (put None if there isn't any XRF scan to be read)

path_photo = path_scan + 'VenereFoto/'       # photo of the scanned section

list_path_database = [path_shared + 'Database/']   # tabulated phases

### Output ###
subfolder_output = 'output/Venere/'
